...
*** [ ] - TC xx - *Need* pause test cases here
...
*** [ ] - TC xx - *Need* anti-loop test cases here
...
6. Update support for 'done' (https://nodered.org/docs/creating-nodes/node-js#receiving-messages)
7. Update support for error handling (https://nodered.org/docs/creating-nodes/node-js#handling-errors)
...
var states = {
    ...
    run:   { 0: off, on: on, off: off, pause: pause,   suspend: pause,   continue: doNothing, stop: stop,      cancel: cancel }
};
...
*** Complex state transistions

need to define this, it's with time settings and topics and extra fields, etc.
